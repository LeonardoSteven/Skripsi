<?php
//connect databasse//
require '../Controller/login_sc.php';
?>
  ...
  <header class="border-b-black border-2">
    ...
    <div class="flex flex-col w-full max-w-md p-12 space-y-4 text-center bg-gray-50 text-gray-800 mx-auto">
	    <h1 class="text-3xl font-semibold">Sign in to your account</h1>
	        <a class="text-sm text-gray-600" href="../index.php">Not admin click here !</a>
          <?php if(isset($tap)) : ?>
            <i style="color:red; ">email/password salah!</i>
        <?php endif; ?>
	            <form novalidate="" class="space-y-4 ng-untouched ng-pristine ng-valid" method="post">
                        <div class="flex flex-col">
                            <label for="email" class="sr-only">Email address</label>
                            <input name="email" id="email" type="email" placeholder="Email address" class="rounded-t-md border-gray-400 bg-gray-50 text-gray-800 focus:ring-violet-600 focus:border-violet-600 focus:ring-2">
                            <label for="password" class="sr-only">Password</label>
                            <input name="password" id="password" type="password" placeholder="Password" class="-mt-1 rounded-b-md border-gray-400 bg-gray-50 text-gray-800 focus:ring-violet-600 focus:border-violet-600 focus:ring-2">
                        </div>
		            <button name="button" type="submit" class="px-8 py-3 space-x-2 font-semibold rounded bg-violet-600 text-gray-50">Sign in</button>
	            </form>
    </div>
