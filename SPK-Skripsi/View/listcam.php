<?php
//connect databasse//
require '../Controller/listcam_sc.php';
?>
...
<html>
  ...
  <header class="border-b-black border-2">
    ...
    <div class="brand py-3 px-10 border-4 border-black hover:translate-x-6 transition ease-in-out delay-150">
        <a class="b" href="detailitem.php?id=<?= $cam['kamera_id'] ?>">
          <img class="sony" src="../Assets Kamera/<?= $cam['brand_name'] ?>/<?= $cam['kamera_img'] ?>">
          <p class="a"><?= $cam['kamera_name'] ?></p>
        </a>    
    </div>
    ...
    <footer>
    <div class="flex flex-col w-full max-w-md p-3 space-y-4 text-center bg-gray-50 text-gray-800 mx-auto">  
      <a class="text-sm text-gray-600" href="../index.php">Go To Brand Camera Page</a>
    </div>
        <div class="m">
          <span class=" flex pt-3 space-x-6 sm:justify-center md:mt-0 text-sm text-midnight dark:text-midnight">© 2023 Elcamera. All Rights Reserved.
            </span>
