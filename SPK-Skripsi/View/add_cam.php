<?php
//connect databasse//
require '../Controller/add_cam_sc.php';
?>
	...
	<form method="POST" enctype="multipart/form-data" novalidate="" action="" class="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid">
		<fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm ">
			<div class="space-y-2 col-span-full lg:col-span-1">
				<p class="font-medium">Add Camera Information</p>
			</div>
			<div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                ...
                <option value="<?=$merk['brand_id']?>"><?= $merk['brand_name']?></option>
                <?php
                endforeach;
                ?>
				...
				<div class="col-span-full sm:col-span-3">
					...
					<input name="tipe" id="tipe" type="text" placeholder="Kamera Name" class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-indigo-400 dark:border-gray-700 dark:text-gray-900">
				</div>
				<div class="col-span-full sm:col-span-3">
					<label for="pix" class="text-sm">Pixel</label>
					<input name="pix" id="pix" type="text" placeholder="Pixel" class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-indigo-400 dark:border-gray-700 dark:text-gray-900">
				</div>
                <div class="col-span-full sm:col-span-3">
					<label for="harga" class="text-sm">Harga</label>
					<input name="harga" id="harga" type="text" placeholder="Harga" class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-indigo-400 dark:border-gray-700 dark:text-gray-900">
				</div>
                <div class="col-span-full sm:col-span-2">
					<label for="reso_name" class="text-sm">Resolution</label>
					<input name="reso_name" id="reso_name" type="text" placeholder="1280x720/1920x1080/..." class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-indigo-400 dark:border-gray-700 dark:text-gray-900">
				</div>
				<div class="col-span-full sm:col-span-2">
                    ...
                    <Option value="4">2576x1450 - 3840x2160</Option>
                    <Option value="3">2048x1080 - 2560x1440</Option>
                    <Option value="2">1280x800 - 1920x1080</Option>
                    <Option value="1">0 - 1280x720</Option>
                    </select>
				</div>
                <div class="col-span-full sm:col-span-2">
				...
				<div class="col-span-full sm:col-span-2">
					...
					<input name="iso" id="iso" type="text" placeholder="ISO" class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-indigo-400 dark:border-gray-700 dark:text-gray-900">
				</div>
				<div class="col-span-full sm:col-span-2">
					<label for="beban" class="text-sm">Beban</label>
					<input name="beban" id="beban" type="text" placeholder="Beban" class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-indigo-400 dark:border-gray-700 dark:text-gray-900">
				</div> 
                <div class="col-span-full sm:col-span-3">
					<label for="shutter" class="text-sm">Shutter Speed</label>
					<input name="shutter" id="shutter" type="text" placeholder="Shutter Speed" class="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-indigo-400 dark:border-gray-700 dark:text-gray-900">
				</div>
                <div class="col-span-full sm:col-span-3">
				...
				<div class="col-span-full items-center space-x-2 ">
					<button name="submit" type="submit" class="px-4 py-2 border rounded-md dark:border-gray-100">Submit</button>
				</div>
        </div>
		</fieldset>
	</form>
